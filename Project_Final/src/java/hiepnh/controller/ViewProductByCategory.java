...
public class ViewProductByCategory extends HttpServlet {
    ...
    request.setCharacterEncoding("utf-8");
        try {
            ...
            List<ProductDTO> resultByCategory = dao.loadProductByCategory(categoryName);
            request.setAttribute("RESULT", resultByCategory);
            List<String> categoryList = dao.getCategoryName();
